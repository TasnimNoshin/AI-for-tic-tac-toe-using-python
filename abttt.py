...
#playes the game
    ...
    while (isBoardFull(current)==False): #while there are empty space in the board
        if n==0: #checking if its computer against computer
            computerA=TreeBuildAB(current,'X')[-3] #calling TreeBuildAB() function to get the best move
            ...
            computerB=TreeBuildAB(current,'O')[-3] #calling TreeBuildAB() function to get the best move
        ...
        if n==1: #checking if its computer against human
            ...
            if isBoardFull(current)==True: break #if board is full break the loop
            computer=TreeBuildAB(current,'O')[-3] #calling TreeBuildAB() function to get the best move
